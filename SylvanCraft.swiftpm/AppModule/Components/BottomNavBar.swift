...
struct BottomNavBar: View {
    ...
    var body: some View {
        HStack(spacing: 0) {
            ForEach(items, id: \.tab) { item in
                Button {
                    ...
                    .foregroundStyle(selection == item.tab ? SylvanTheme.gold : SylvanTheme.textOnWood.opacity(0.55))
        ...
        .background(
            ...
            .overlay(Rectangle().fill(SylvanTheme.darkWood).frame(height: 1), alignment: .top)
