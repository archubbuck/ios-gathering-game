...
enum PickupNodeFactory {
    ...
    static func makePotionNode() -> SCNNode {
        ...
        let light = SCNLight()
        light.type = .omni
        light.color = SceneKitConversions.uiColor(TimberlineTheme.Scene3D.potionGlowLight)
        light.intensity = 60
    ...
    private static func orbGeometry() -> SCNGeometry {
        ...
        let geometry = LowPolyGeometry.facetedBlob(
            ...
            seed: 0x9070_1104,
            baseColor: TimberlineTheme.Scene3D.potionGlow,
            highlightColor: TimberlineTheme.Scene3D.potionGlowLight
        )
