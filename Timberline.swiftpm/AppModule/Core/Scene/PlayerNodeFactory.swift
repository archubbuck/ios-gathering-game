...
enum PlayerNodeFactory {
    ...
    static func makeNode(axeTier: AxeTier) -> SCNNode {
        ...
        for leg in legs {
            ...
            calf.geometry?.materials = [material(color: TimberlineTheme.Scene3D.skin)]
            ...
            shoe.geometry?.materials = [material(color: TimberlineTheme.Scene3D.shoes)]
        ...
        shorts.geometry?.materials = [material(color: TimberlineTheme.Scene3D.shorts)]
        ...
        vest.geometry?.materials = [material(color: TimberlineTheme.Scene3D.vest)]
        ...
        collar.geometry?.materials = [material(color: TimberlineTheme.Scene3D.shirt)]
    ...
    private static func makeArm(
        ...
        upperArm.geometry?.materials = [material(color: TimberlineTheme.Scene3D.shirt)]
        ...
        forearm.geometry?.materials = [material(color: TimberlineTheme.Scene3D.skin)]
        forearm.position = SCNVector3(0, -3.5, 0)
        forearmPivot.addChildNode(forearm)

        let hand = SCNNode(geometry: SCNSphere(radius: 3.2))
        hand.geometry?.materials = [material(color: TimberlineTheme.Scene3D.skin)]
    ...
    static func rebuildAxe(in forearmPivot: SCNNode, tier: AxeTier) {
        ...
        handle.geometry?.materials = [material(color: TimberlineTheme.barkLight)]
