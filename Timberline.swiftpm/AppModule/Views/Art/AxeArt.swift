...
struct AxeArt: View {
    ...
    var body: some View {
        ...
        ZStack {
            Capsule()
                .fill(TimberlineTheme.barkLight)
                .overlay(Capsule().stroke(TimberlineTheme.darkWood.opacity(0.5), lineWidth: 1))
            ...
            AxeHeadShape()
                ...
                .overlay(AxeHeadShape().stroke(TimberlineTheme.darkWood.opacity(0.55), lineWidth: 1.2))
